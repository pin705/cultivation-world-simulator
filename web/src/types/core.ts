...
export interface AvatarDetail extends EntityBase {
  ...
  player_objective_updated_month?: number;
  player_objective_cooldown_months?: number;
  player_objective_remaining_cooldown_months?: number;
  player_support_updated_month?: number;
  player_support_cooldown_months?: number;
  player_support_remaining_cooldown_months?: number;
  player_seed_updated_month?: number;
  player_seed_until_month?: number;
  player_seed_cooldown_months?: number;
  player_seed_remaining_cooldown_months?: number;
  player_seed_duration_months?: number;
  player_seed_remaining_duration_months?: number;
  player_owned_sect_id?: number | null;
  player_owned_sect_name?: string | null;
  player_main_avatar_id?: string | null;
  player_main_avatar_name?: string | null;
  is_player_owned_avatar?: boolean;
  is_player_main_avatar?: boolean;
  player_can_set_main_avatar?: boolean;
  player_intervention_points?: number;
  player_intervention_points_max?: number;
  player_objective_cost?: number;
  player_objective_can_afford?: boolean;
  player_objective_can_update?: boolean;
  player_support_cost?: number;
  player_support_amount?: number;
  player_support_can_afford?: boolean;
  player_support_can_grant?: boolean;
  player_seed_cost?: number;
  player_seed_can_afford?: boolean;
...
export interface SectDetail extends EntityBase {
  ...
  player_directive?: string;
  player_directive_updated_month?: number;
  player_directive_cooldown_months?: number;
  player_directive_remaining_cooldown_months?: number;
  player_owned_sect_id?: number | null;
  player_owned_sect_name?: string | null;
  is_player_owned_sect?: boolean;
  player_can_claim_sect?: boolean;
  player_intervention_points?: number;
  player_intervention_points_max?: number;
  player_directive_cost?: number;
  player_relation_intervention_cost?: number;
  player_relation_intervention_delta?: number;
  player_relation_intervention_duration_months?: number;
  player_directive_can_afford?: boolean;
  player_directive_can_update?: boolean;
...
export interface SectDiplomacyItem {
  ...
  player_relation_intervention_remaining_cooldown_months?: number;
  player_relation_intervention_can_intervene?: boolean;
}
