...
class AvatarLoadMixin:
    ...
    def from_save_dict(cls, data: dict, world: "World") -> "AvatarLoadMixin":
        ...
        avatar.player_objective_updated_month = int(data.get("player_objective_updated_month", -1) or -1)
        avatar.player_support_updated_month = int(data.get("player_support_updated_month", -1) or -1)
        avatar.player_seed_updated_month = int(data.get("player_seed_updated_month", -1) or -1)
        avatar.player_seed_until_month = int(data.get("player_seed_until_month", -1) or -1)
