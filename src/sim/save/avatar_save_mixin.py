...
class AvatarSaveMixin:
    ...
    def to_save_dict(self) -> dict:
        ...
        return {
            ...
            "player_objective_updated_month": int(getattr(self, "player_objective_updated_month", -1) or -1),
            "player_support_updated_month": int(getattr(self, "player_support_updated_month", -1) or -1),
            "player_seed_updated_month": int(getattr(self, "player_seed_updated_month", -1) or -1),
            "player_seed_until_month": int(getattr(self, "player_seed_until_month", -1) or -1),
