...
def save_game(
    ...
    room_runtime_snapshot: Optional[dict] = None,
    ...
    try:
        ...
        sect_runtime_states = {
            str(sect.id): {
                ...
                "player_directive_updated_month": int(getattr(sect, "player_directive_updated_month", -1) or -1),
        ...
        world_data = {
            ...
            "room_runtime_snapshot": dict(
                room_runtime_snapshot
                or getattr(world, "room_runtime_snapshot", {})
                or {}
            ),
            "active_controller_id": getattr(world, "get_active_controller_id", lambda: "local")(),
            "player_control_seats": getattr(world, "export_player_control_seats", lambda: {})(),
            "player_profiles": getattr(world, "export_player_profiles", lambda: {})(),
            "player_intervention_points": int(getattr(world, "player_intervention_points", 0) or 0),
            "player_owned_sect_id": getattr(world, "get_player_owned_sect_id", lambda: None)(),
            "player_main_avatar_id": getattr(world, "get_player_main_avatar_id", lambda: None)(),
            ...
            "player_relation_intervention_cooldowns": dict(
                getattr(world, "player_relation_intervention_cooldowns", {}) or {}
            ),
